...
#+end_src
** TODO COMMENT Project managment library
*** TODO Compile projects files
#+begin_src emacs-lisp
  (defconst predefined-projects-dir-name "projects")

  (defun create-project-instance project-file-name
    ;; TODO
    )

  (defun temacs-load-predefined-projects ()
    (defvar predefined-projects-dir
      (file-name-concat user-emacs-directory predefined-projects-dir-name))
    (unless file-exists-p predefined-projects-dir
      (make-directory predefined-projects-dir))

    (defvar predefined-projects
      (iter-do 'project-file-name (directory-files predefined-projects-dir t ".*\.project" t)
	       (create-project-instance project-file-name))))

  (defun temacs-load-project project-path
    ;; TODO
    )

#+end_src
*** TODO Build project files queue
*** TODO Open file callback function generator
** TODO COMMENT Project managment library (rework)
#+begin_src emacs-lisp
  (defun turn-on-project (project-path)
    "TODO"
    )

  (defun turn-off-project (project-path)
    "TODO"
    )

  (defun switch-project (project-path)
    "TODO"
    )
  ...
  (defun find-file-with-project (project-path file-path)
    "TODO"
    )
#+end_src
** Term mode settings
  ...
  (defun find_temacs_project_dir_and_file (start_point_arg &optional temacs_project_file_name_arg)
	...
	(
	 ...
	 (temacs_project_file (file-name-concat temacs_project_dir temacs_project_file_name))
      ...
      (list temacs_project_dir temacs_project_file)
      )
    )
...
#+end_src
* Projects
** TODO Import file with projects
* Debugging
** COMMENT 1
#+begin_src emacs-lisp
